...
from pytorch_trainer.config import Config
...
trainer = BasicTrainer(model, loss_func, optim, tdl, num_epochs=10)
tinspector = TrainerInspector()
tlogger = Logger('training.csv')
